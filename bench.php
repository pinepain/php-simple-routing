...
function simple_bench($nRoutes, $nMatches)
{
    ...
    $filter = new \Pinepain\SimpleRouting\Filter([new \Pinepain\SimpleRouting\Filters\Formats(new \Pinepain\SimpleRouting\Filters\Helpers\FormatsCollection([['default', '[^/]+']]))]);
