...
class FormatsHandlerTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testHandleDefault() {
        ...
        $this->assertEquals('test%20%E4%B8%AD%E5%9B%BD%20%2F%E4%B8%AD%E5%9C%8B', $handler->handleDefault('test 中国 /中國'));
        $this->assertEquals('test%20%D0%BA%D0%B8%D1%80%D0%B8%D0%BB%D0%BB%D0%B8%D1%86%D0%B0', $handler->handleDefault('test кириллица'));
        $this->assertEquals('test%20%E0%A4%B9%E0%A4%BF%E0%A4%82%E0%A4%A6%E0%A5%80', $handler->handleDefault('test हिंदी'));
    }
    ...
    public function testHandle() {
        ...
        $handler = $this->getMock('Pinepain\SimpleRouting\FormatsHandler', ['handleDefault'], [['known' => $format_handler]]);
